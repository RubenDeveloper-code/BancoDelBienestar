...
public class Cargos extends javax.swing.JInternalFrame {
    ...
    public Cargos(Administrador cuentas) {
    ...
    private void initComponents() {
        ...
        cargar = new javax.swing.JTextPane();
        ...
        jScrollPane2.setViewportView(cargar);
    ...
    private void realizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_realizarActionPerformed
        ...
        if((cuenta = cuentas.getCuentaPorNumCuenta(numero.getText())) != null){
            texto.setText("Cuenta antes del cargo:\n"+cuentas.buscarCuentaPorNumeroCuenta(numero.getText()));
            cuenta.cargarSaldo(Float.valueOf(cargar.getText()));
            texto.append("\nCuenta despues del cargo:\n"+cuentas.buscarCuentaPorNumeroCuenta(numero.getText()));
        } else
    ...
    private javax.swing.JTextPane cargar;
